\begin{table}[t]
\centering
\caption{Marginal calibration of the deployment p-values on null streams (191,890 betting instants pooled over 60 cameras). This checks Layer 1 in isolation: the p-values must be super-uniform before any betting takes place. The smallest attainable p-value is 0.0018, which is the tail resolution the exact Beta levels of \cref{thm:beta} provide.}
\label{tab:pcoverage}
