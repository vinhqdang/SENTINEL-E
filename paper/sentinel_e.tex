...
\item \textbf{Exact calibration-conditional conformal levels.}
      ...
      shortens detection delay by a factor of \AblDkwSpeedup{}
      (\cref{sec:ablation}).
...
\input{../results/tables/tab1_validity}
\input{../results/tables/tab2_horizon}
...
\input{../results/tables/tab3_delay_far}
...
\input{../results/tables/tab4_coverage}
\input{../results/tables/tab5_activity}
...
\input{../results/tables/tab6_network}
...
\input{../results/tables/tab7_compute}
...
\input{../results/tables/tab9_diagnostics}
\input{../results/tables/tab10_pcoverage}
...
\input{../results/tables/tab8_ablation}
